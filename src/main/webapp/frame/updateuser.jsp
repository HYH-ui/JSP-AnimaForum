...
<DIV id=nav>
    <A href="<%=path %>">九重天动漫论坛 </A>»更新用户信息
</DIV>
<FORM onsubmit=this.regsubmit.disabled=true; method=post name=updateuser
    ...
    <DIV class="mainbox formbox">
        ...
        <TABLE cellSpacing=0 cellPadding=0 summary="Submit Button">
            ...
            <TR>
                ...
                <TD>
                    <BUTTON tabIndex=100 class="button" type='submit' name=regsubmit
                            value="Confirm" >
                        提交
                    </BUTTON>
                </TD>
