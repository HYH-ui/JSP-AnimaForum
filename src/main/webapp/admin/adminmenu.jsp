...
<div id=forums>
	<table class=leftmenulist style="margin-bottom: 5px" cellspacing=0 cellpadding=0
		...
		<tr class=leftmenutext>
			<td><a onclick=collapse_change(1)><img
					id=menuimg_1 border=0 src="<%=imgPath %>/menu_reduce.gif"></a>&nbsp;
				<a onclick=collapse_change(1)>分区管理</a></td></tr>
		<tbody id=menu_1>
		<tr class=leftmenutd>
			<td>
	...
	<table class=leftmenulist style="margin-bottom: 5px" cellspacing=0 cellpadding=0
		...
		<tr class=leftmenutext>
			<td><a onclick=collapse_change(2)><img
				...
				<a onclick=collapse_change(2)>版块管理</a></td></tr>
		<tbody id=menu_2>
		<tr class=leftmenutd>
			<td>
				<table class=leftmenuinfo cellspacing=0 cellpadding=0 border=0>
	...
	<table class=leftmenulist style="margin-bottom: 5px" cellspacing=0 cellpadding=0
		...
		<tr class=leftmenutext>
			<td><a onclick=collapse_change(3)><img
				...
				<a onclick=collapse_change(3)>子版块管理</a></td></tr>
		<tbody id=menu_3>
		<tr class=leftmenutd>
			<td>
				<table class=leftmenuinfo cellspacing=0 cellpadding=0 border=0>
	...
	<table class=leftmenulist style="margin-bottom: 5px" cellspacing=0 cellpadding=0
		...
		<tbody>
		<tr class=leftmenutext>
			<td><a onclick=collapse_change(4) ><img
		...
		<tr class=leftmenutd>
			<td>
				<table class=leftmenuinfo cellspacing=0 cellpadding=0 border=0>
					<tbody>
					<tr>
						<td><a href="frame/adduser.jsp">添加会员</a>
						</td>
					</tr>
					</tbody>
				</table>
